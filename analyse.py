...
fieldnames = ['Participant ID',
              ...
              'Destination Country',
              'Trace Hop Count',
              'Hop 1 IP', 'Hop 1 Hostname', 'Hop 1 OS (nmap name)', 'Hop 1 OS (nmap confidence)', 'Hop 1 RTT', 'Hop 1 ASN', 'Hop 1 City', 'Hop 1 Country',
              'Hop 2 IP', 'Hop 2 Hostname', 'Hop 2 OS (nmap name)', 'Hop 2 OS (nmap confidence)', 'Hop 2 RTT', 'Hop 2 ASN', 'Hop 2 City', 'Hop 2 Country',
              'Hop 3 IP', 'Hop 3 Hostname', 'Hop 3 OS (nmap name)', 'Hop 3 OS (nmap confidence)', 'Hop 3 RTT', 'Hop 3 ASN', 'Hop 3 City', 'Hop 3 Country',
              'Hop 4 IP', 'Hop 4 Hostname', 'Hop 4 OS (nmap name)', 'Hop 4 OS (nmap confidence)', 'Hop 4 RTT', 'Hop 4 ASN', 'Hop 4 City', 'Hop 4 Country',
              'Hop 5 IP', 'Hop 5 Hostname', 'Hop 5 OS (nmap name)', 'Hop 5 OS (nmap confidence)', 'Hop 5 RTT', 'Hop 5 ASN', 'Hop 5 City', 'Hop 5 Country',
              'Hop 6 IP', 'Hop 6 Hostname', 'Hop 6 OS (nmap name)', 'Hop 6 OS (nmap confidence)', 'Hop 6 RTT', 'Hop 6 ASN', 'Hop 6 City', 'Hop 6 Country',
              'Hop 7 IP', 'Hop 7 Hostname', 'Hop 7 OS (nmap name)', 'Hop 7 OS (nmap confidence)', 'Hop 7 RTT', 'Hop 7 ASN', 'Hop 7 City', 'Hop 7 Country',
              'Hop 8 IP', 'Hop 8 Hostname', 'Hop 8 OS (nmap name)', 'Hop 8 OS (nmap confidence)', 'Hop 8 RTT', 'Hop 8 ASN', 'Hop 8 City', 'Hop 8 Country',
              'Hop 9 IP', 'Hop 9 Hostname', 'Hop 9 OS (nmap name)', 'Hop 9 OS (nmap confidence)', 'Hop 9 RTT', 'Hop 9 ASN', 'Hop 9 City', 'Hop 9 Country',
              'Hop 10 IP', 'Hop 10 Hostname', 'Hop 10 OS (nmap name)', 'Hop 10 OS (nmap confidence)', 'Hop 10 RTT', 'Hop 10 ASN', 'Hop 10 City', 'Hop 10 Country',
              'Hop 11 IP', 'Hop 11 Hostname', 'Hop 11 OS (nmap name)', 'Hop 11 OS (nmap confidence)', 'Hop 11 RTT', 'Hop 11 ASN', 'Hop 11 City', 'Hop 11 Country',
              'Hop 12 IP', 'Hop 12 Hostname', 'Hop 12 OS (nmap name)', 'Hop 12 OS (nmap confidence)', 'Hop 12 RTT', 'Hop 12 ASN', 'Hop 12 City', 'Hop 12 Country',
              'Hop 13 IP', 'Hop 13 Hostname', 'Hop 13 OS (nmap name)', 'Hop 13 OS (nmap confidence)', 'Hop 13 RTT', 'Hop 13 ASN', 'Hop 13 City', 'Hop 13 Country',
              'Hop 14 IP', 'Hop 14 Hostname', 'Hop 14 OS (nmap name)', 'Hop 14 OS (nmap confidence)', 'Hop 14 RTT', 'Hop 14 ASN', 'Hop 14 City', 'Hop 14 Country',
              'Hop 15 IP', 'Hop 15 Hostname', 'Hop 15 OS (nmap name)', 'Hop 15 OS (nmap confidence)', 'Hop 15 RTT', 'Hop 15 ASN', 'Hop 15 City', 'Hop 15 Country',
              'Hop 16 IP', 'Hop 16 Hostname', 'Hop 16 OS (nmap name)', 'Hop 16 OS (nmap confidence)', 'Hop 16 RTT', 'Hop 16 ASN', 'Hop 16 City', 'Hop 16 Country',
              'Hop 17 IP', 'Hop 17 Hostname', 'Hop 17 OS (nmap name)', 'Hop 17 OS (nmap confidence)', 'Hop 17 RTT', 'Hop 17 ASN', 'Hop 17 City', 'Hop 17 Country',
              'Hop 18 IP', 'Hop 18 Hostname', 'Hop 18 OS (nmap name)', 'Hop 18 OS (nmap confidence)', 'Hop 18 RTT', 'Hop 18 ASN', 'Hop 18 City', 'Hop 18 Country',
              'Hop 19 IP', 'Hop 19 Hostname', 'Hop 19 OS (nmap name)', 'Hop 19 OS (nmap confidence)', 'Hop 19 RTT', 'Hop 19 ASN', 'Hop 19 City', 'Hop 19 Country']
...
with open('results.csv', 'w') as csvfile:
    ...
    for entry in os.scandir(args.results_dir):
        ...
        print('Processing %s...' % (scamper_filename))
        ...
        if scamper_filename.endswith('.json'):
            with open(scamper_filename, 'r') as f:
                ...
                # - run nmap OS detection if it's not a local IP
                if 'hops' in trace:
